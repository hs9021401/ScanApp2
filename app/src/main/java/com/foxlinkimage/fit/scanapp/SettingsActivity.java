...
public class SettingsActivity extends ActionBarActivity {
    EditText edtIP;
    ToggleButton tgbtnAdvancedOption;
    ...
    protected void onDestroy() {
        String tmp_IP = mPreferenceHelper.getPreference(PreferenceHelper.key_IP);
        if (!tmp_IP.equals(edtIP.getText().toString())) {
            mPreferenceHelper.setPreference(PreferenceHelper.key_IP, edtIP.getText().toString());
        }
        super.onDestroy();
    }
    ...
    void setupComponent() {
        ...
        tgbtnAdvancedOption = (ToggleButton) findViewById(R.id.advance_option);
        ...
        tgbtnAdvancedOption.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
        ...
        //IP
        edtIP.setText(mPreferenceHelper.getPreference(PreferenceHelper.key_IP));
        ...
        spnDocumentFormat.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                mPreferenceHelper.setPreference(PreferenceHelper.key_DOCUMENT_FORMAT, adapterView.getSelectedItem().toString());
            }
        ...
        spnInputSource.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                mPreferenceHelper.setPreference(PreferenceHelper.key_INPUT_SOURCE, adapterView.getSelectedItem().toString());
            }
        ...
        spnColorMode.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                mPreferenceHelper.setPreference(PreferenceHelper.key_COLOR_MODE, adapterView.getSelectedItem().toString());
            }
        ...
        spnColorSpace.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                mPreferenceHelper.setPreference(PreferenceHelper.key_COLOR_SPACE, adapterView.getSelectedItem().toString());
            }
        ...
        spnCcdChannel.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                mPreferenceHelper.setPreference(PreferenceHelper.key_CCD_CHANNEL, adapterView.getSelectedItem().toString());
            }
        ...
        spnBinaryRendering.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                mPreferenceHelper.setPreference(PreferenceHelper.key_BINARY_RENDERING, adapterView.getSelectedItem().toString());
            }
        ...
        spnDuplex.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                mPreferenceHelper.setPreference(PreferenceHelper.key_DUPLEX, adapterView.getSelectedItem().toString());
            }
        ...
        spnDiscreteResolution.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                mPreferenceHelper.setPreference(PreferenceHelper.key_DISCRETE_RESOLUTION, adapterView.getSelectedItem().toString());
            }
    ...
    void loadPreference() {
        ...
        for (int i = 0; i < mode.length; i++) {
            if (mode[i].equals(mPreferenceHelper.getPreference(PreferenceHelper.key_COLOR_MODE))) {
        ...
        for (int i = 0; i < source.length; i++) {
            if (source[i].equals(mPreferenceHelper.getPreference(PreferenceHelper.key_INPUT_SOURCE))) {
        ...
        for (int i = 0; i < dpi.length; i++) {
            if (dpi[i].equals(mPreferenceHelper.getPreference(PreferenceHelper.key_DISCRETE_RESOLUTION))) {
        ...
        for (int i = 0; i < format.length; i++) {
            if (format[i].equals(mPreferenceHelper.getPreference(PreferenceHelper.key_DOCUMENT_FORMAT))) {
